...
namespace _05.BinarySearchTree
{
    ...
    //     상위스킬을 배워야 하위스킬을 배울 수 있는 스킬트리 , 행동트리(behavior Tree) 몬스터의 AI(Unreal) - 유니티의 경우 보통 상태머신 사용(그래프)...
    ...
    {
        public T item;
        public TreeNode<T> parent;  //부모노드
        public List<TreeNode<T> > children; //자식노드들 
    }
