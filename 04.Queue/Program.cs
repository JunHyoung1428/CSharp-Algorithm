namespace _04.Queue
{
    ...
    {/******************************************************
        ...
        //****** C++은 노드 기반의 자료구조가 효율적이라, 스택,큐도 연결리스트로 구현함
        //****** C#은 그렇지 않아서 아래와 같은 방식으로 구현함  
        ...
        static void Main(string[] args)
        {
            ...
            for(int i = 0; i < 5; i++) 
            {
                queue.Enqueue(i); // 큐는 푸시 대신 인큐 씀
            }

            Console.WriteLine(queue.Peek()); // 픽은 있음, 출력: 0


            for (int i = 0;i < 5; i++)
            {
               int val =  queue.Dequeue(); // 꺼내는건 디큐, 출력: 0, 1, 2, 3, 4
